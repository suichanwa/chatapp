var f=Object.defineProperty;var y=(d,i,e)=>i in d?f(d,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):d[i]=e;var r=(d,i,e)=>y(d,typeof i!="symbol"?i+"":i,e);import{ChatApp as w}from"./ChatApp-lnYSjVDo.js";class M{async initialize(){this.render()}render(){const i=document.querySelector(".app-status-container");i&&(i.innerHTML=`
